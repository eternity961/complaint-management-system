...
import distributiveSidebar from "@/assets/constants/distributiveSIdebar";
import NotificationDropdown from "./NotificationDropdown";

const DistributiveNavbar = () => {
...
export default DistributiveNavbar;
